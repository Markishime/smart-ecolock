...
void watchdogCheck() {
  // Feed both task and interrupt watchdogs (without using ESP.wdtFeed)
  yield();
...
void setup() {
  ...
  // Note: Not all ESP32 Arduino cores expose this function directly
  // Use the ESP-IDF version if available
